...
/////////////////////////////////////////////////////////////////////////////////////////////
  ...
  void asserTourner3 (float angle_degre_consigne,float tab_odometrie [])
  {
    ...
    float position_n_moins_1_roue2 = tab_odometrie[5]; // Roue gauche
    float position_n_moins_1_roue1 = tab_odometrie[3]; // Roue droite
...
// Calcul de l'angle parcouru depuis la dernière fois
      angle_radian_parcouru = R_Roue_codeuse/R_centre_roue*(tab_odometrie[5]-position_n_moins_1_roue2) ;

// Acquisition des valeurs actuelles des roues incrémentales pour la prochaine boucle
      position_n_moins_1_roue1=tab_odometrie[3];
      position_n_moins_1_roue2=tab_odometrie[5];
